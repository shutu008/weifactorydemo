...
public class HandControl {
    ...
    public void setHandControlId(Long handControlId) {
        this.handControlId = handControlId;
    }

    public String getHeadControlMod() {
        return headControlMod;
    }

    public void setHeadControlMod(String headControlMod) {
